        ...
        <body>
            ...
            <div class="container">
                <div class="subcontainer">
                    ...
                    <p>Olá, <b>${name}</b>. A organização ${organization_name} criou seu usuário grati, para configurar sua conta clique no botão abaixo:</p>
                    <a href="${link}"><button>Configurar conta</button></a>
