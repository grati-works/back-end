        ...
        <body>
            ...
            <div class="container">
                <div class="subcontainer">
                    ...
                    <p>Olá, <b>${name}</b>. A organização ${organization_name} foi criada com sucesso, para configurá-la clique no botão abaixo:</p>
                    <a href="${link}"><button>Configurar organização</button></a>
